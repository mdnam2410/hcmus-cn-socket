...
SC_SCREENSHOT_CANNOT_TAKE = 700
SC_FILE_CANNOT_GET_LIST = 801
SC_FILE_CANNOT_GET_FILE = 802
SC_FILE_CANNOT_RENAME = 803
SC_FILE_CANNOT_SEND = 804
SC_FILE_CANNOT_DELETE = 805
...
STATUS_MESSAGES = {
    ...
    SC_FILE_CANNOT_GET_LIST: "Cannot get list file and folder",
    SC_FILE_CANNOT_GET_FILE: "Cannot download file",
    SC_FILE_CANNOT_RENAME: "Cannot rename file",
    SC_FILE_CANNOT_SEND: "Cannot upload file",
    SC_FILE_CANNOT_DELETE: "Cannot delete file"
}

MESSAGE_ENCODING = 'utf-8'
DATA_ENCODEING = 'base64'
SERVER_PORT = 9098
SOCKET_BUFFER = 1024
